...
train_feature = np.loadtxt("../51/train.feature.tfidf.txt")
valid_feature = np.loadtxt("../51/valid.feature.tfidf.txt")
test_feature = np.loadtxt("../51/test.feature.tfidf.txt")
