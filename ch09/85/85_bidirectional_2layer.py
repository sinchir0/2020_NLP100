...
def train_fn(
    ...
    for dataloader_x, dataloader_y in loader:
        ...
        dataloader_y_pred_prob = model(
            x=dataloader_x,
            h_0=torch.zeros(2 * 2, BATCHSIZE, HIDDEN_SIZE).to(
                device
...
if __name__ == "__main__":
    ...
    make_graph(losses, "losses", bn=BATCHSIZE, method="rnn_bidirectional_2layer")
    make_graph(accs, "accs", bn=BATCHSIZE, method="rnn_bidirectional_2layer")
